...
import Images from '../../shared/components/UIElements/Images';
...
const PlaceItem = (props) =>{
    ...
    <li className="place-item">
        ...
        <div className="place-item__image">
            {/* <img scr={require('./download.png')} alt={props.title}/> */}
            <Images image={props.image} alt={props.title}/>
            
            </div>
        <div className="props-image__info">
            <h2>{props.title}</h2>
            <h3>{props.address}</h3>
